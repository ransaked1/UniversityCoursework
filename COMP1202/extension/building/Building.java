...
public class Building {
  ...
  public Building(int topFloor, int constructionPoints) {
    ...
    this.initialConstructionPoints = constructionPoints;
    this.topFloor = topFloor;
  }

  /**
   * Adds construction points to the building. Can't have more construction points than at the
   * beginning of the game.
   *
   * @param repairPoints To add to the construction points.
   */
  public void repair(int repairPoints) {
    constructionPoints += repairPoints;

    if (constructionPoints > initialConstructionPoints) {
      constructionPoints = initialConstructionPoints;
    }
  }
