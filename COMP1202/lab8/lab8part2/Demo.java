...
public class Demo {
  public static void main(String[] args) {
    ...
    // What is an interface? An interface is an abstract class that imposes a certain structure when
    // implemented.
    // How does it differ from an abstract class? All its methods are abstract and variables final
    // static. Has no contructor.
