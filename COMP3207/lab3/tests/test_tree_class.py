...
class TestTreeMethods(unittest.TestCase):   
    ...
    # #TODO: Refactor these when we have a CloudDB
    ...
    def test_get_address(self):
      ...
      tree = Tree(ident=100,
        coordinates=(50.93304715,-1.3900633),address="85, Upper Shaftesbury Avenue, Portswood, Southampton, England, SO17 3RU, United Kingdom", species = "Bamboo Bamboozle")
      tree.get_address()
      #self.assertEqual(tree.address,"85, Upper Shaftesbury Avenue, Portswood, Southampton, England, SO17 3RU, United Kingdom")        
      #Updating as Azure Maps returns this address as coordinates instead
      # Note we have to sacrifice the ward, as Azure Maps does not have the information
      self.assertEqual(tree.address,"83, Upper Shaftesbury Avenue, Southampton, England, SO17 3RW, United Kingdom")        
